...
import type {
  ...
  PreflightLifecycleEntry, PreflightPipelineCoverage, PreflightScannerStats,
...
// item 5c: preflight:scanner_stats — was `any`.
export type ScannerStats = PreflightScannerStats;
